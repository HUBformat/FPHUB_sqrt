...
VL_INLINE_OPT void VFPHUB_sqrt::_sequent__TOP__1(VFPHUB_sqrt__Syms* __restrict vlSymsp) {
    ...
    if (vlTOPp->rst_l) {
        if (vlTOPp->start) {
            vlTOPp->FPHUB_sqrt__DOT__F1[0U] = 0x1e000000U;
            vlTOPp->FPHUB_sqrt__DOT__F_1[0U] = 0x1e000000U;
            __Vdlyvset__FPHUB_sqrt__DOT__S__v0 = 1U;
            __Vdlyvval__FPHUB_sqrt__DOT__W__v0 = ((0x800000U 
                                                   & vlTOPp->x)
                                                   ? 
                                                  (0x2000002U 
                                                   | (0x1fffffcU 
                                                  ...
                                                  (0x1000001U 
                                                   | (0xfffffeU 
                                                      & (vlTOPp->x 
                                                         << 1U))));
            vlTOPp->FPHUB_sqrt__DOT__F1[1U] = 0x1b000000U;
            vlTOPp->FPHUB_sqrt__DOT__F_1[1U] = 0x3000000U;
                    ...
                    if ((8U > (0xfU & ((((0x1eU >= 
                        ...
                        while (VL_LTES_III(1,32,32, vlTOPp->FPHUB_sqrt__DOT__unnamedblk3__DOT__k, 
                            ...
                            if (VL_LIKELY((2U >= (3U 
                                                  & ((IData)(2U) 
                                                     - vlTOPp->FPHUB_sqrt__DOT__unnamedblk3__DOT__k))))) {
                                vlTOPp->FPHUB_sqrt__DOT__f1_test 
                                    = (((~ ((IData)(1U) 
                                            << (3U 
                                                & ((IData)(2U) 
                                                   - vlTOPp->FPHUB_sqrt__DOT__unnamedblk3__DOT__k)))) 
                                        & (IData)(vlTOPp->FPHUB_sqrt__DOT__f1_test)) 
                        ...
                        vlTOPp->FPHUB_sqrt__DOT____Vlvbound20 = 3U;
                        if (((0x1cU >= (0x1fU & (((IData)(0x1cU) 
                                                  - vlTOPp->FPHUB_sqrt__DOT__j) 
                                                 - (IData)(4U)))) 
                             & (0x1eU >= (0x1fU & ((IData)(1U) 
                        ...
                        while (VL_LTES_III(1,32,32, vlTOPp->FPHUB_sqrt__DOT__unnamedblk4__DOT__k, 
                            ...
                            vlTOPp->FPHUB_sqrt__DOT____Vlvbound22 = 0U;
                            if (VL_LIKELY(((0x1cU >= 
                                            (0x1fU 
                                             & vlTOPp->FPHUB_sqrt__DOT__unnamedblk4__DOT__k)) 
                                           & (0x1eU 
                        ...
                        vlTOPp->FPHUB_sqrt__DOT____Vlvbound23 = 3U;
                        if ((0x18U >= (0x1fU & ((IData)(1U) 
                                                + vlTOPp->FPHUB_sqrt__DOT__j)))) {
                        ...
                        while (VL_LTES_III(1,32,32, vlTOPp->FPHUB_sqrt__DOT__unnamedblk5__DOT__k, 
                            ...
                            vlTOPp->FPHUB_sqrt__DOT____Vlvbound28 
                                = ((0x1cU >= (0x1fU 
                                              & ((IData)(0x1cU) 
                                                 - vlTOPp->FPHUB_sqrt__DOT__unnamedblk5__DOT__k))) 
                                   & (((0x1eU >= (0x1fU 
                        ...
                        vlTOPp->FPHUB_sqrt__DOT____Vlvbound30 = 3U;
                        if (((0x1cU >= (0x1fU & (((IData)(0x1cU) 
                                                  - vlTOPp->FPHUB_sqrt__DOT__j) 
                                                 - (IData)(4U)))) 
                             & (0x1eU >= (0x1fU & ((IData)(1U) 
                            ...
                            if (VL_LIKELY(((0x1cU >= 
                                ...
                                vlTOPp->FPHUB_sqrt__DOT__F_1[(0x1fU 
                                    ...
                                    = (((~ ((IData)(1U) 
                                        ...
                                        [(0x1fU & ((IData)(1U) 
                                                   + vlTOPp->FPHUB_sqrt__DOT__j))]) 
                                       | ((IData)(vlTOPp->FPHUB_sqrt__DOT____Vlvbound32) 
                                          << (0x1fU 
                                              & vlTOPp->FPHUB_sqrt__DOT__unnamedblk6__DOT__k)));
                            }
                            vlTOPp->FPHUB_sqrt__DOT__unnamedblk6__DOT__k 
